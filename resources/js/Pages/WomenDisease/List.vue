...
const breadcrumbs = ref([{ title: "Kadın Hastalıkları Kayıtlarınız" }]);
...
<template>
    <Head title="Kadın Hastalıkları Kayıtlarınız" />

    <AuthenticatedLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto p-4">
            <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-5">
                <div><Title text="Kadın Hastalıkları Kayıtlarınız" /></div>
                <div
                    class="flex lg:justify-end md:justify-end justify-start items-center"
                >
                    <Link :href="route('women-disease.create')"
                        ...
                        <TableCell>
                            <DropdownMenu as-child>
                                ...
                                <DropdownMenuContent>
                                    <DropdownMenuItem
                                        :as="Link"
                                        :href="route('women-disease.show', data.id)"
